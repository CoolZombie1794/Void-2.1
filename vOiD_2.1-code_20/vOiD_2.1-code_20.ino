...
//15 : Update - Removing delays by adding separate loops
...
if(distance_F>set){chk = 0;}
     ...
     if((bt_ir_data == 1) && (chk==0)){chk = 1; forword(); }  // if the bt_data is '1' the DC motor will go forward
...
if((digitalRead(R_S) == 0)&&(digitalRead(L_S) == 0) && (chk==0)){chk = 1;forword();}  //if Right Sensor and Left Sensor are at White color then it will call forword function
