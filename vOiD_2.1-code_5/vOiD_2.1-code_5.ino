...
else if(bt_ir_data == 9){mode=1; Speed=100;} //Auto Line Follower Command
...
//                          Lights
//=============================================================================== 
     if(bt_ir_data == 11){digitalWrite(12, HIGH);}  
else if(bt_ir_data == 12){digitalWrite(12, LOW);}
else if(bt_ir_data == 13){digitalWrite(12, LOW);}
